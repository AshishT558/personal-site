    ...
    return (
        <main>
            ...
            <div id="about_preview" className="h-screen">
                ...
                My interests include solving intricate problems by utilizing software solutions, working with teams on artificial intelligence and machine learning projects, and learning more about the intersection of hardware and software in robotics."
                reverse={false}
                content=
