    ...
    <ContentPage title="About Me">
      <div id="Content" className="flex flex-col">
        ...
        <div className="mx-5 flex flex-col">
          <div className="mt-[2rem] flex flex-col gap-y-10 text-center lg:grid lg:grid-cols-2 lg:gap-x-10">
            ...
            <div id="photo_grid" className="relative lg:ml-10">
              <Image className="ml-5 mt-5 lg:absolute border z-30" src={ProfilePic} alt={"bench pic"} width={300} height={200}></Image>
              ...
              <Image className="lg:absolute border lg:mt-[35rem] lg:ml-5 z-10" src={TennisPic} alt={"tennis pic"} width={400} height={200}></Image>
