            ...
            <Image className="lg:hidden border rounded-full" src={LinkedIn} alt={"bench pic"} width={150} height={200}></Image>
                  ...
                  <p className="w-[23rem] text-center">Hi! I'm Ashish, and I'm a student at Northeastern University in Boston, Massachusetts. 
                    ...
                    <p className="mt-[2rem] w-[26rem]">
                      I previously completed my co-ops at the MBTA <span><a target="_blank" rel="noopener noreferrer" href="https://www.mbta.com/"><Image className="rounded inline hover:scale-105" src={MBTA} alt={"mbta pic"} width={20} height={10}></Image></a> </span>, The TJX Companies, Inc. <span><a target="_blank" rel="noopener noreferrer" href="https://www.tjx.com/"><Image className="rounded inline hover:scale-105" src={TJXLogo} alt={"tjx pic"} width={20} height={10}></Image></a> </span>, and an internship as a Software Engineer at Atlassian <span><a target="_blank" rel="noopener noreferrer" href="https://www.atlassian.com/"><Image className="rounded inline hover:scale-105" src={AtlassianLogo} alt={"atlassian pic"} width={20} height={10}></Image></a> </span>!
                      <br></br><br></br>I am also a Community Group Leader at Northeastern's South Asian Intervarsity 
                        ...
                        <br></br> <br></br>
                         As I continue this academic year, I am looking for open internship or full-time roles in Software Engineering, Data Science, or Machine Learning for 2026/2027. 
                    </p> 
